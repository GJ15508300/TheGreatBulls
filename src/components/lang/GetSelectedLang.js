...
import { languageSelection, selectedlanguage } from '../../redux/slices/authSlice';
...
export const useSelectedLanguage = () => {
  ...
  const getSelectedLanguage = () => {
    ...
    console.log('selectedLanguageId',selectedLanguageId,'1st',selectedLanguageId === 'English','2',selectedLanguageId === 'Tamil');
...
export const setSelectedLanguage = (id) => {
